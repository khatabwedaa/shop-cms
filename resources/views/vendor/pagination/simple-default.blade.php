@if ($paginator->hasPages())
    <nav>
        <div class="flex rounded">
            ...
            @else
                <a href="{{ $paginator->previousPageUrl() }}" class="py-2 px-4 leading-tight bg-white border border-gray-200 text-blue-700 border-r-0 hover:bg-blue-500 hover:text-white">
